...
import com.iadjuster.service.GoalService;
...
public class GoalController {
	...
	public String getGoals(Model model) {
		...
		model.addAttribute("to_goalreport",	goals);  
		 // To be used in getGoals.jsp file
	...
	public String getGoalReports(Model model) {
		...
		model.addAttribute("to_goalReports",	goalReports);
							// To be used in getGoalReorts.jsp file
