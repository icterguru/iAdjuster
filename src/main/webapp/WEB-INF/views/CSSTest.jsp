  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <button type="button" class="w3-btn w3-theme"><i class="fa fa-pencil"></i> ÊPost</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="w3-container w3-card-2 w3-white w3-round w3-margin"><br>
        ...
        <button type="button" class="w3-btn w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up"></i> ÊLike</button>
        <button type="button" class="w3-btn w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i> ÊComment</button>
      </div>
